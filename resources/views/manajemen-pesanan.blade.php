            ...
            <div class="grid grid-cols-1 gap-4 md:hidden">
                ...
                <div class="bg-white p-5 rounded-2xl shadow-sm border border-gray-100 relative">
                    <div class="flex justify-between items-start mb-4">
                        <div>
                            <span class="inline-block py-1 px-2.5 rounded-lg bg-blue-50 text-blue-600 text-xs font-bold mb-2">#{{ $order->id }}</span>
                            <h3 class="font-bold text-gray-900 text-lg">{{ $order->customer->nama ?? $order->nama_customer }}</h3>
